...
#			
			...
			RUN bash Anaconda3-2021.11-Linux-x86_64.sh | yes yes 
			# NOTE: this bash line requires 'reading' the license, and a 'yes' being typed in...
			RUN cd ~
			RUN source .bashrc
			# rmdir tmp 
			# rmdir won't work as not empty!
