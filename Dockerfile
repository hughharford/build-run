...
#
#		Spotify (old e)
# NOT WORKING: (unsure why, seemed to work ok in U_20.04 root)
#			RUN snap install spotify

# 		VLC
#				REF: it's complicated, see: https://launchpad.net/ubuntu/+source/vlc
#					=> manual installation for now
#			RUN apt-get install VLC

#		Office365WebDesktop for linux (posco)
# NOT WORKING:
#			RUN snap install unofficial-webapp-office

#		Slack (posco, yetitool.com, quantconnect?)
# NOT WORKING:
...
ENTRYPOINT ["/bin/bash", echo "Welcome, $name"]
